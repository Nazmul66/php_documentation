...
class Shape{
  ...
  class Shapes{
     ...
     // this (Shape) added to first arguments before that it will call those class who will extent the Shape that can be countable and work. Others will be not work or it will show error
