...
## (Module:22.4) ---> Multiple SQL WhereClosure Grouping
![Alt Text](https://github.com/Nazmul66/php_documentation/blob/main/Asset/WhereClosure_grouping_22.4.png) 

## (Module:22.5) ---> Multiple different Table combine to get data 
...
## (Module:22.9) ---> SQL aggregation function and grouping
![Alt Text](https://github.com/Nazmul66/php_documentation/blob/main/Asset/SQL_aggregation_function_and_grouping_22.9.png) 

## (Module:22.10) ---> SQL aggregation function and grouping result with Data filtering
![Alt Text](https://github.com/Nazmul66/php_documentation/blob/main/Asset/SQL_aggregation_function_and_grouping_result_with_Data_filtering_22.10.png)
### NOTE: Using Group BY (WHERE closure) will not worked, replacement using (HAVING) function

## (Module:22.11) ---> SQL Sub Select usable
![Alt Text](https://github.com/Nazmul66/php_documentation/blob/main/Asset/SQL_Sub_Select_22.11.png)

## (Module:22.12) ---> SQL aggregation function and Joining together
![Alt Text](https://github.com/Nazmul66/php_documentation/blob/main/Asset/SQL_aggregation_function_and_Joining_together_22.12.png)
### NOTE: 2 way method can be implement but different function 

## (Module:22.13) ---> SQL aggregation function and multiple data table joining
![Alt Text](https://github.com/Nazmul66/php_documentation/blob/main/Asset/aggregation_function_and_multiple_table_join_22.13.png)

## (Module:22.14) ---> SQL different joining and inner joining
![Alt Text](https://github.com/Nazmul66/php_documentation/blob/main/Asset/SQL_inner_join_22.14.png)

## (Module:22.15) ---> SQL LEFT JOIN    
![Alt Text](https://github.com/Nazmul66/php_documentation/blob/main/Asset/SQL_Left_Join_22.15.png)
